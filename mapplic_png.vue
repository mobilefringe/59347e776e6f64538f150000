            ...
            methods: {
                ...
                loadStoreData() {
                    ...
                    _.forEach(vm.floorlist, function(value) { 
                        ...
                        floor_1.locations = [];
                        var stores_on_floors = _.filter(vm.storelist, function(o) { if(o.z_coordinate == null || o.z_coordinate == 0) {return true;} else { return value.z_index === o.z_coordinate; }}); // ['z_coordinate', value.z_index]);
