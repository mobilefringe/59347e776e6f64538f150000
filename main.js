...
require(['Vue', 'vue2-filters', 'vue_router', 'routes', 'store', 'vue-i18n', 'locales', 'moment', "vue-meta"], function (Vue, Vue2Filters, VueRouter, appRoutes, store, VueI18n, messages, moment, Meta) {
  ...
  const vm = new Vue({
    ...
    created() {
      this.$store.commit('SET_URL', {url: "https://www.mallmaverick.com/api/v4/halifaxcentre/all.json" });
      ...
      this.$store.dispatch('LOAD_META_DATA', {url: "https://www.mallmaverick.com/api/v4/halifaxcentre/all.json"});
